...
parser.add_argument("train_variant", type=int)
...
combined_variables_list_sortedDeepJetB = combined_variables_list_sortedDeepJetB + ["HT__nom", "HTRat__nom", "HTH__nom", "HTb__nom", "nMediumDeepJetB__nom", "nFTAJet__nom", "sphericity", "isElMu"]
...
variables_list_used = []
if args.train_variant == 1:
    if args.train_mode == 2 or args.train_mode == 4: variables_list_used = combined_variables_list_sortedDeepJetB
    else: variables_list_used = combined_variables_list
else:
    if args.train_mode == 2 or args.train_mode == 4: variables_list_used = individual_variables_list_sortedDeepJetB
...
if args.train_mode == 1:
    out_filename = "v4/AUC_summary.txt"
elif args.train_mode == 2:
    out_filename = "v4_sorted/AUC_summary.txt"
elif args.train_mode == 3:
    out_filename = "v4_tanh/AUC_summary.txt"
elif args.train_mode == 4:
    out_filename = "v4_sorted_tanh/AUC_summary.txt"

with open(out_filename, "a") as AUC_file:
    AUC_file.write(args.model_path + ' ' + str(args.train_variant) + ' train ' + str(train_sig_acceptance_list) + '\n')
    AUC_file.write(args.model_path + ' ' + str(args.train_variant) + ' test ' + str(test_sig_acceptance_list) + '\n')