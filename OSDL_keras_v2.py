...
def base_model(input_len):
    ...
    model_layer = Dropout(args.dropout)(model_layer)
...
if args.mode == 1:
    ...
    combined_filepath="OSDL_keras_v2_combined-{epoch:03d}" + "-{:.2f}.hdf5".format(args.dropout)
    ...
    with open("OSDL_keras_v2_combined_{:.2f}_history.p".format(args.dropout), "wb") as history_pickle:
        pickle.dump(combined_history.history, history_pickle)
    combined_model.save("OSDL_keras_v2_combined_{:.2f}.hdf5".format(args.dropout))
elif args.mode == 2:
    ElMu_model = base_model(len(individual_variables_list))
    ElMu_filepath="OSDL_keras_v2_ElMu-{epoch:03d}" + "-{:.2f}.hdf5".format(args.dropout)
    ...
    with open("OSDL_keras_v2_ElMu_{:.2f}_history.p".format(args.dropout), "wb") as history_pickle:
        pickle.dump(ElMu_history.history, history_pickle)
    ElMu_model.save("OSDL_keras_v2_ElMu_{:.2f}.hdf5".format(args.dropout))
elif args.mode == 3:
    MuMu_model = base_model(len(individual_variables_list))
    MuMu_filepath="OSDL_keras_v2_MuMu-{epoch:03d}" + "-{:.2f}.hdf5".format(args.dropout)
    ...
    with open("OSDL_keras_v2_MuMu_{:.2f}_history.p".format(args.dropout), "wb") as history_pickle:
        pickle.dump(MuMu_history.history, history_pickle)
    MuMu_model.save("OSDL_keras_v2_MuMu_{:.2f}.hdf5".format(args.dropout))